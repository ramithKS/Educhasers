                                        ...
                                        echo'<div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="roll_id" placeholder="Enter Roll Id" value="'.$row[2].'">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="username" placeholder="Enter Username" value="'.$row[3].'">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="exampleInputEmail1">EMAIL</label>
                                                    <input type="email" class="form-control" name="email" placeholder="Enter email" value="'.$row[4].'">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="password" class="form-control" name="password" placeholder="Enter Password" value="'.$row[5].'">
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="address" placeholder="Enter Address" value="'.$row[7].'">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="exampleInputEmail1">PHONE NUMBER</label>
                                                    <input type="text" class="form-control" name="p_n" placeholder="Enter Phone Number" value="'.$row[8].'">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
