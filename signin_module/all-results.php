...
<title>ALL RESULTS - SCHOOL MANAGEMENT SYSTEM</title>
                                        ...
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while (($row = mysqli_fetch_array($result)))
                                                {
                                                    ...
                                                    if($row_result!= null){
                                                        echo'<tr>';
                                                        echo'<td class="text-nowrap">'.$row_result[0].'</td>';
                                                        echo'<td class="text-nowrap">'.$row[1].'</td>';
                                                        echo'<td class="text-nowrap">'.$row_result[3].'</td>';
    ...
    $(document).ready(function () {
        ...
        $("#dataTableExample2").DataTable({
            ...
            buttons: [
                ...
                {extend: 'csv', title: 'REPORTS RECORD', className: 'btn-sm'},
                {extend: 'excel', title: 'REPORTS RECORD', className: 'btn-sm'},
                {extend: 'pdf', title: 'REPORTS RECORD', className: 'btn-sm'},
