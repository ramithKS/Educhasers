...
<title>UPDATE PROFILE - SCHOOL MANAGEMENT SYSTEM</title>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <form action="t-profile.php" method="POST" enctype="multipart/form-data">
                                    <?php
                                    {
                                    $id = $_SESSION['teacher'];
                                    ...
                                    echo'<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="address" placeholder="Enter Address" value="'.$row_teacher[6].'">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="p_n" placeholder="Enter Phone Number" value="'.$row_teacher[7].'">
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        ?>
                                        <br>
                                        <button type="submit" name="update_teacher" class="btn btn-primary">UPDATE PROFILE</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
$target_file="uploads/profile.png";
  ...
  $link = "<script>window.open('t-profile.php','_self')</script>";
  echo $link;
  }
  $conn->close();
}
