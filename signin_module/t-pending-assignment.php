                            ...
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        {
                                        echo'<tr>
                                        <td>'.$row_assignment[0].'</td>
                                        <td>'.$row_assignment[1].'</td>
                                        <td>'.$row_assignment[2].'</td>
                                        <td>'.$row_assignment[3].'</td>
                                        <td style="background-color:green;">'.$row_assignment[4].'</td>';
    ...
    $(document).ready(function () {
        ...
        $("#dataTableExample2").DataTable({
            ...
            buttons: [
                ...
                {extend: 'csv', title: 'PENDING ASSIGNMENTS', className: 'btn-sm'},
                {extend: 'excel', title: 'PENDING ASSIGNMENTS', className: 'btn-sm'},
                {extend: 'pdf', title: 'PENDING ASSIGNMENTS', className: 'btn-sm'},
...
if(!is_null($result))
{
$link = "<script>window.open('t-pending-assignments.php','_self')</script>";
echo $link;
}
}
?>