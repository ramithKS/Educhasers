...
<title>ALL SUBJECTS - SCHOOL MANAGEMENT SYSTEM</title>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="subject" placeholder="Enter Class Name">
                                                </div>
                                                <div class="col-sm-6">
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                echo'
                                                <tr>
                                                <td>'.$row_subjects[0].'</td>
                                                <td>'.$row_subjects[1].'</td>';
                                                $query_teacher = "SELECT * FROM teacher WHERE id='$row_subjects[2]'";
                                                $result_teacher =mysqli_query($conn,$query_teacher);
                                                $row_teacher = mysqli_fetch_array($result_teacher);
                                                echo'<td>'.$row_teacher[1].'</td>';
                                                echo'<td>
                                                <a href="all-subjects.php?id='.$row_subjects[0].'" class="btn btn-sm btn-primary m-r-5">DELETE</a>
                                                </td>
                                                </tr>';
                                                }
                                                ?>
    ...
    $(document).ready(function () {
        ...
        $("#dataTableExample2").DataTable({
            ...
            buttons: [
                ...
                {extend: 'csv', title: 'ALL SUBJECTS', className: 'btn-sm'},
                {extend: 'excel', title: 'ALL SUBJECTS', className: 'btn-sm'},
                {extend: 'pdf', title: 'ALL SUBJECTS', className: 'btn-sm'},
...
$teacher = $_POST['teacher'];
  ...
  $link = "<script>window.open('all-subjects.php','_self')</script>";
  echo $link;
  }
  $conn->close();
}
