...
<title>ALL CLASES - SCHOOL MANAGEMENT SYSTEM</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>ALL CLASSES AND CLASS TEACHERS</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
    ...
    $(document).ready(function () {
        ...
        $("#dataTableExample2").DataTable({
            ...
            buttons: [
                ...
                {extend: 'csv', title: 'CLASSES RECORD', className: 'btn-sm'},
                {extend: 'excel', title: 'CLASSES RECORD', className: 'btn-sm'},
...
$teacher = $_POST['teacher'];
  ...
  $link = "<script>window.open('classes.php','_self')</script>";
  echo $link;
  }
  $conn->close();
}
